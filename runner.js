...
const task = new Task(
  ...
  "Проведение физического эксперимента в лаборатории"
);
const emergencyProtocol = new EmergencyProtocol(
  "Протокол пожара",
  "Тушение пожара и восстановление безопасности",
  1
);
const emergencyTask = new EmergencyTask(
  "Тушение пожара",
  "Тушение пожара в лаборатории",
  emergencyProtocol
);
